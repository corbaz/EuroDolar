...
var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v(JSON.parse("{\"pageTitleGlobal\":\"Euro Dolar | ARS Currency Tracker\",\"pageDescriptionGlobal\":\"Track USD (Blue & Oficial - Buy/Sell) and EUR (Official - Buy/Sell) exchange rates against Argentinian Peso (ARS) for a selected date.\",\"headerTitle\":\"Euro Dolar\",\"headerSubtitle1\":\"✔️ View US Dollar (Blue & Oficial - Buy/Sell).\",\"headerSubtitle2\":\"📌 View Euro (Official - Buy/Sell) in Argentinian Pesos (ARS).\",\"languageSwitcherLabelEN\":\"English\",\"languageSwitcherLabelES\":\"Español\",\"languageToggleARIALabel\":\"Toggle language\",\"selectDateCardTitle\":\"Select Date for Rate\",\"yearSelectPlaceholder\":\"Year\",\"monthSelectPlaceholder\":\"Month\",\"calendarFooterNoDate\":\"Pick a day for exchange rates.\",\"calendarFooterWithDate\":\"Selected: {{date}}\",\"compraShort\":\"Buy\",\"ventaShort\":\"Sell\",\"noExchangeRateDataGeneric\":\"No exchange rate data currently available for the selected criteria for {{date}}.\",\"noExchangeRateDataSpecific\":\"No exchange rate data found for {{currency}} on {{date}}.\",\"pleaseSelectDay\":\"Please select a day from the calendar to fetch rates.\",\"loadingDatePicker\":\"Loading date picker...\",\"modalTitle\":\"Currency Exchange Rates\",\"modalRatesPreambleText\":\"Rates for\",\"modalCloseButton\":\"Close\",\"usdBlueLabel\":\"USD (Blue)\",\"usdOficialLabel\":\"USD (Official)\",\"eurLabel\":\"EUR (Official)\",\"dataNotAvailableOnDate\":\"No data available for {{currency}} on this date.\",\"apiErrorsTitle\":\"API Errors\",\"apiErrorsDescriptionItem\":\"{{error}}\",\"criticalErrorTitle\":\"Critical Error\",\"toastNoValidDateTitle\":\"No Valid Date Selected\",\"toastNoValidDateDescription\":\"Please select a valid date to fetch currency data.\",\"toastInvalidDateTitle\":\"Invalid Date\",\"toastInvalidDateDescriptionFuture\":\"Cannot select future dates.\",\"toastInvalidDateDescriptionPast\":\"Date cannot be before {{date}}.\",\"toastInvalidYearTitle\":\"Invalid Year\",\"toastInvalidYearDescriptionFuture\":\"Cannot select future years. Displaying current month.\",\"toastInvalidYearDescriptionPast\":\"Year cannot be before {{year}}. Displaying earliest available month.\",\"toastInvalidMonthTitle\":\"Invalid Month\",\"toastInvalidMonthDescriptionFuture\":\"Cannot select future months. Displaying current month.\",\"toastInvalidMonthDescriptionPast\":\"Month cannot be before {{monthYear}}. Displaying earliest available month.\",\"footerCopyrightText\":\"Euro Dolar © {{year}}\",\"historyCardTitle\":\"Last 10 Business Days History\",\"historyTableDate\":\"Date\",\"historyTableCurrency\":\"Currency\",\"historyTableBuy\":\"Buy\",\"historyTableSell\":\"Sell\",\"historyLoadingText\":\"Loading history...\",\"historyNoDataText\":\"No historical data available for the last 10 business days.\",\"selectedDateFallback\":\"a selected date\"}"));}}),
"[project]/src/locales/es.json (json)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v(JSON.parse("{\"pageTitleGlobal\":\"Euro Dolar | Seguimiento Moneda ARS\",\"pageDescriptionGlobal\":\"Rastrea las tasas de cambio de USD (Blue y Oficial - Compra/Venta) y EUR (Oficial - Compra/Venta) frente al Peso Argentino (ARS) para una fecha seleccionada.\",\"headerTitle\":\"Euro Dolar\",\"headerSubtitle1\":\"📌 Ver Dólar E.E.U.U. (Blue y Oficial - Compra/Venta).\",\"headerSubtitle2\":\"✔️ Ver Euro (Oficial - Compra/Venta) en Pesos Argentinos (ARS).\",\"languageSwitcherLabelEN\":\"English\",\"languageSwitcherLabelES\":\"Español\",\"languageToggleARIALabel\":\"Cambiar idioma\",\"selectDateCardTitle\":\"Seleccionar Fecha para ver la Cotización\",\"yearSelectPlaceholder\":\"Año\",\"monthSelectPlaceholder\":\"Mes\",\"calendarFooterNoDate\":\"Elige un día para ver la Cotización.\",\"calendarFooterWithDate\":\"Seleccionado: {{date}}\",\"compraShort\":\"Compra\",\"ventaShort\":\"Venta\",\"noExchangeRateDataGeneric\":\"No hay datos de cotización disponibles para los criterios seleccionados para {{date}}.\",\"noExchangeRateDataSpecific\":\"No se encontraron datos de cotización para {{currency}} en {{date}}.\",\"pleaseSelectDay\":\"Por favor, selecciona un día del calendario para obtener las cotizaciones.\",\"loadingDatePicker\":\"Cargando selector de fecha...\",\"modalTitle\":\"Cotizaciones de Moneda\",\"modalRatesPreambleText\":\"Cotizaciones para\",\"modalCloseButton\":\"Cerrar\",\"usdBlueLabel\":\"USD (Blue)\",\"usdOficialLabel\":\"USD (Oficial)\",\"eurLabel\":\"EUR (Oficial)\",\"dataNotAvailableOnDate\":\"No hay datos disponibles para {{currency}} en esta fecha.\",\"apiErrorsTitle\":\"Errores de API\",\"apiErrorsDescriptionItem\":\"{{error}}\",\"criticalErrorTitle\":\"Error Crítico\",\"toastNoValidDateTitle\":\"No se seleccionó una fecha válida\",\"toastNoValidDateDescription\":\"Por favor, selecciona una fecha válida para obtener los datos de moneda.\",\"toastInvalidDateTitle\":\"Fecha Inválida\",\"toastInvalidDateDescriptionFuture\":\"No se pueden seleccionar fechas futuras.\",\"toastInvalidDateDescriptionPast\":\"La fecha no puede ser anterior al {{date}}.\",\"toastInvalidYearTitle\":\"Año Inválido\",\"toastInvalidYearDescriptionFuture\":\"No se pueden seleccionar años futuros. Mostrando mes actual.\",\"toastInvalidYearDescriptionPast\":\"El año no puede ser anterior a {{year}}. Mostrando el primer mes disponible.\",\"toastInvalidMonthTitle\":\"Mes Inválido\",\"toastInvalidMonthDescriptionFuture\":\"No se pueden seleccionar meses futuros. Mostrando mes actual.\",\"toastInvalidMonthDescriptionPast\":\"El mes no puede ser anterior a {{monthYear}}. Mostrando el primer mes disponible.\",\"footerCopyrightText\":\"Euro Dolar © {{year}}\",\"historyCardTitle\":\"Historial Últimos 10 Días Hábiles\",\"historyTableDate\":\"Fecha\",\"historyTableCurrency\":\"Moneda\",\"historyTableBuy\":\"Compra\",\"historyTableSell\":\"Venta\",\"historyLoadingText\":\"Cargando historial...\",\"historyNoDataText\":\"No hay datos históricos disponibles para los últimos 10 días hábiles.\",\"selectedDateFallback\":\"una fecha seleccionada\"}"));}}),
...
function LanguageProvider({ children }) {
    const [locale, setLocaleState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('en'); // Default to English
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    const dateLocale = dateLocales[locale] || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$en$2d$US$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enUS"];
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1df86ca3._.js.map